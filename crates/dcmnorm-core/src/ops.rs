...
/// ```
/// # use dcmnorm_core::Tag;
/// # use dcmnorm_core::ops::AttributeSelector;
/// // select Patient Name
...
/// ```
/// # use dcmnorm_core::Tag;
/// # use dcmnorm_core::ops::{AttributeSelector, AttributeSelectorStep};
...
/// # use dcmnorm_core::{Tag, ops::AttributeSelector};
/// use dcmnorm_core::dictionary::DataDictionary;
/// # use dcmnorm_core::dictionary::stub::StubDataDictionary;
/// # /* faking an import
