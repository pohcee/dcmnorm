...
impl PrimitiveValue {
    ...
    ///
    /// ```
    /// # use dcmnorm_core::dicom_value;
    /// # use dcmnorm_core::value::{C, PrimitiveValue, DicomDate};
    /// # use smallvec::smallvec;
    ...
    /// ```
    /// # use dcmnorm_core::dicom_value;
    /// # use dcmnorm_core::value::{C, DicomDate, PrimitiveValue};
    /// # use smallvec::smallvec;
    /// assert_eq!(
    ...
    ///
    /// ```
    /// # use dcmnorm_core::value::{C, PrimitiveValue};
    /// # use smallvec::smallvec;
    ///
    /// assert_eq!(
    ...
    /// # use chrono::NaiveDate;
    /// # use std::error::Error;
    /// use dcmnorm_core::value::{AsRange, DicomDate};
    ...
    /// # use dcmnorm_core::dicom_value;
    /// use dcmnorm_core::value::DicomDate;
    /// # use std::error::Error;
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    /// assert_eq!(
    ...
    ///
    /// ```
    /// # use dcmnorm_core::value::{C, PrimitiveValue, DicomTime};
    /// # use smallvec::smallvec;
    ...
    /// # use dcmnorm_core::value::{C, PrimitiveValue};
    /// # use chrono::NaiveTime;
    /// use dcmnorm_core::value::{AsRange, DicomTime};
    /// # use std::error::Error;
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    ...
    /// # use dcmnorm_core::value::{C, PrimitiveValue};
    /// # use smallvec::smallvec;
    /// use dcmnorm_core::value::DicomTime;
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    /// assert_eq!(
    ///     PrimitiveValue::Strs(smallvec![
    ...
    /// # use std::error::Error;
    /// use dcmnorm_core::value::{DicomDateTime, AsRange, DateTimeRange, PreciseDateTime};
    ///
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    ...
    /// use chrono::{NaiveDate};
    /// # use std::error::Error;
    /// use dcmnorm_core::value::{DateRange};
    ///
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    ...
    /// use chrono::{NaiveTime};
    /// # use std::error::Error;
    /// use dcmnorm_core::value::{TimeRange};
    ///
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    ...
    /// # use std::error::Error;
    /// use dcmnorm_core::value::{DateTimeRange, PreciseDateTime};
    ///
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
    ...
    /// # use dcmnorm_core::value::{C, PrimitiveValue};
    /// # use std::error::Error;
    /// use dcmnorm_core::value::range::{AmbiguousDtRangeParser, ToKnownTimeZone, IgnoreTimeZone, FailOnAmbiguousRange, DateTimeRange};
    ...
    /// # use dcmnorm_core::value::{C, PrimitiveValue};
    /// # use std::error::Error;
    /// use dcmnorm_core::value::PersonName;
    /// # fn main() -> Result<(), Box<dyn Error>> {
    ///
...
impl PrimitiveValue {
    ...
    /// ```
    /// use dcmnorm_core::dicom_value;
    /// # use dcmnorm_core::value::ModifyValueError;
    ///
