...
/// use dcmnorm_core::value::{DicomDate, AsRange};
...
/// use dcmnorm_core::value::{DicomTime, AsRange};
/// # fn main() -> Result<(), Box<dyn Error>> {
///
...
/// use dcmnorm_core::value::{DicomDate, DicomTime, DicomDateTime, AsRange, PreciseDateTime};
/// # fn main() -> Result<(), Box<dyn Error>> {
///
...
impl DicomTime {
    ...
    /// # Ok::<(), dcmnorm_core::value::DeserializeError>(())
    /// ```
