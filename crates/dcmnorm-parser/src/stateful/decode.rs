...
use dcmnorm_core::dictionary::VirtualVr;
use dcmnorm_core::header::{DataElementHeader, HasLength, Length, SequenceItemHeader, Tag, VR};
use dcmnorm_core::value::deserialize::{
...
use dcmnorm_encoding::decode::basic::{BasicDecoder, LittleEndianBasicDecoder};
use dcmnorm_encoding::decode::explicit_le::ExplicitVRLittleEndianDecoder;
use dcmnorm_encoding::decode::{BasicDecode, DecodeFrom};
use dcmnorm_encoding::text::{
...
pub enum Error {
    ...
    DecodeElementHeader {
        position: u64,
        #[snafu(backtrace)]
        source: dcmnorm_encoding::decode::Error,
    },
    ...
    DecodeText {
        position: u64,
        #[snafu(backtrace)]
        source: dcmnorm_encoding::text::DecodeTextError,
    },
    ...
    DeserializeValue {
        position: u64,
        source: dcmnorm_core::value::deserialize::Error,
    },
...
mod tests {
    ...
    use dcmnorm_core::header::{DataElementHeader, HasLength, Header, Length, SequenceItemHeader};
    use dcmnorm_core::{Tag, VR};
    use dcmnorm_encoding::decode::basic::LittleEndianBasicDecoder;
    use dcmnorm_encoding::decode::{
        explicit_le::ExplicitVRLittleEndianDecoder, implicit_le::ImplicitVRLittleEndianDecoder,
    };
    use dcmnorm_encoding::text::{SpecificCharacterSet, TextCodec};
