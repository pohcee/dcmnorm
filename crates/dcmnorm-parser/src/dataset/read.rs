...
use dcmnorm_core::header::{DataElementHeader, Header, Length, SequenceItemHeader};
use dcmnorm_core::{PrimitiveValue, Tag, VR};
use dcmnorm_encoding::text::SpecificCharacterSet;
        ...
        if self.in_sequence {
            ...
            match self.parser.decode_item_header() {
                ...
                Err(DecoderError::DecodeItemHeader {
                    source: dcmnorm_encoding::decode::Error::ReadItemHeader { source, .. },
                    ..
        ...
        }) = self.seq_delimiters.last()
        {
            ...
            match self.parser.decode_header() {
                ...
                Err(DecoderError::DecodeElementHeader {
                    source: dcmnorm_encoding::decode::Error::ReadHeaderTag { source, .. },
                    ..
                }) if source.kind() == std::io::ErrorKind::UnexpectedEof => {
...
mod tests {
    ...
    use dcmnorm_core::header::{DataElementHeader, Length};
