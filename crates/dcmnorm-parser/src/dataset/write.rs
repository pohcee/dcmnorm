...
use dcmnorm_core::{DataElementHeader, Length, Tag, VR};
use dcmnorm_encoding::encode::EncodeTo;
use dcmnorm_encoding::text::SpecificCharacterSet;
use dcmnorm_encoding::transfer_syntax::DynEncoder;
...
mod tests {
    ...
    use dcmnorm_encoding::encode::{explicit_le::ExplicitVRLittleEndianEncoder, EncoderFor};
